...
(function () {
  ...
  var OFFERS_TYPE_RUS = ['Дворец', 'Квартира', 'Дом', 'Бунгало'];
  ...
  var renderCardArray = function (arr) {
    ...
    var offerIndex = OFFERS_TYPE.findIndex(function (offerName) {
      return offerName === arr.offer.type;
    });
    cloneCardElement.querySelector('.popup__type').textContent = OFFERS_TYPE_RUS[offerIndex];
  ...
  window.main = {
    ...
    renderCardArray: renderCardArray,
